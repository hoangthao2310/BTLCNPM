            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="form-floating mb-3">
                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="mathuonghieu">
                        <option value=""></option>
                        <?php
                        while ($row = mysqli_fetch_assoc($resultMathuonghieu)) {
                ...
                <div class="form-floating mb-4">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px;" name="baoquan"></textarea>
                    <label for="floatingTextarea">Bảo quản</label>
                </div>
                <div class="form-floating mb-4">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px;" name="huongvi"></textarea>
                    <label for="floatingTextarea">Hương vị</label>
                </div>
                <div class="form-floating mb-4">
